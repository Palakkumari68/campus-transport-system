...
export default function AdminLayout() {
  ...
  return (
    <div className="flex min-h-screen bg-[#efefef] text-black">
      <aside
        className={`${
          sidebarOpen ? "w-64" : "w-20"
        } flex min-h-screen flex-col bg-red-500 font-sans transition-all duration-300`}
      >
        <div className="flex items-center gap-3 border-b border-white/15 px-4 py-5">
          ...
          {sidebarOpen && (
            <div className="overflow-hidden">
              <p className="text-lg font-bold leading-tight tracking-wide text-black">
                Campus Admin
              </p>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-3 rounded-full bg-gray-100 px-3 py-2">
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-red-600 text-sm font-bold text-white">
                  {getInitials(currentUser?.fullName || currentUser?.name || "Admin User")}
                </div>

                <div className="hidden sm:block">
                  <p className="text-sm font-semibold text-gray-800">
                    {currentUser?.fullName || currentUser?.name || "Admin User"}
                  </p>
