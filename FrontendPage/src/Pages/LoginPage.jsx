...
export default function LoginPage() {
  ...
  const redirectByRole = (user) => {
    ...
    if (role === "ADMIN") {
      ...
      setError(`Unsupported role: ${role || "Unknown"}`);
    }
  };
  ...
  const handleRegister = async (e) => {
    ...
    try {
      const payload = {
        ...
        rollNumber:
          registerForm.role === "STUDENT" || registerForm.role === "USER"
            ? registerForm.rollNumber
            : "",
      ...
      <div style={styles.leftPanel}>
        ...
        <div style={styles.leftContent}>
          ...
          <p style={styles.description}>
            Admin uses pre-created credentials. Drivers and students/users can
            register themselves, and their details will be saved in the database
            through backend APIs.
          </p>

          <div style={styles.demoBox}>
            <h3 style={styles.demoTitle}>System Access Rules</h3>

            <div style={styles.demoItem}>
              <strong>Admin</strong>
              <p style={styles.demoText}>Use only pre-seeded admin credentials</p>
              <p style={styles.demoText}>Example: admin@campus.edu / Admin@123</p>
            </div>

            <div style={styles.demoItem}>
              <strong>Driver</strong>
              <p style={styles.demoText}>Can register and then login later</p>
              <p style={styles.demoText}>Credentials are stored in MySQL</p>
            </div>

            <div style={styles.demoItem}>
              <strong>Student/User</strong>
              <p style={styles.demoText}>Can register and login with own credentials</p>
              <p style={styles.demoText}>Credentials are stored in MySQL</p>
            </div>
          </div>
        </div>
          ...
          {mode === "login" ? (
            ...
            <form onSubmit={handleRegister}>
              ...
              <p style={styles.formSub}>
                Create your own student, user, or driver account
              </p>
